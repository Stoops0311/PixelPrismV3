...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    colorGrid: hashColorGrid("product-1"),
  },
  {
    id: "2",
    name: "Espresso Blend",
    ...
    colorGrid: hashColorGrid("product-2"),
  },
  {
    id: "3",
    ...
    colorGrid: hashColorGrid("product-3"),
  },
  {
    id: "4",
    name: "Gift Card",
    ...
    colorGrid: hashColorGrid("product-4"),
  },
  {
    id: "5",
    ...
    colorGrid: hashColorGrid("product-5"),
  },
]
...
export const MOCK_GENERATED_IMAGES: GeneratedImage[] = [
  ...
  },
  {
    ...
    colorGrid: hashColorGrid("img-10"),
    aspectRatio: "16:9",
    status: "ready",
  ...
  },
  {
    ...
    colorGrid: hashColorGrid("img-11"),
    aspectRatio: "3:4",
    status: "ready",
  ...
  {
    id: "img-12",
    colorGrid: hashColorGrid("img-12"),
    aspectRatio: "1:1",
    status: "ready",
  ...
  },
  {
    ...
    productId: "2",
    productName: "Espresso Blend",
    colorGrid: hashColorGrid("img-13"),
    aspectRatio: "9:16",
    status: "ready",
  ...
  },
  {
    ...
    productId: "1",
    productName: "Summer Cold Brew",
    colorGrid: hashColorGrid("img-14"),
    aspectRatio: "16:9",
    status: "ready",
  ...
  {
    id: "img-15",
    colorGrid: hashColorGrid("img-15"),
    aspectRatio: "3:4",
    status: "ready",
...
export const MOCK_RECENT_STUDIO_IMAGES: Record<string, RecentStudioImage[]> = {
  "1": [
    { id: "rs-1", colorGrid: hashColorGrid("rs-1"), productName: "Summer Cold Brew", aspectRatio: "1:1", createdAt: "2026-02-16T14:00:00Z" },
    { id: "rs-2", colorGrid: hashColorGrid("rs-2"), productName: "Espresso Blend", aspectRatio: "3:4", createdAt: "2026-02-15T11:00:00Z" },
    { id: "rs-3", colorGrid: hashColorGrid("rs-3"), productName: "Pour-Over Set", aspectRatio: "16:9", createdAt: "2026-02-14T09:00:00Z" },
    { id: "rs-4", colorGrid: hashColorGrid("rs-4"), productName: "Gift Card", aspectRatio: "1:1", createdAt: "2026-02-13T16:00:00Z" },
  ],
  "2": [
    { id: "rs-5", colorGrid: hashColorGrid("rs-5"), productName: "Spring Wetsuit", aspectRatio: "3:4", createdAt: "2026-02-16T10:00:00Z" },
    { id: "rs-6", colorGrid: hashColorGrid("rs-6"), productName: "Surfboard Wax", aspectRatio: "1:1", createdAt: "2026-02-15T14:00:00Z" },
    { id: "rs-7", colorGrid: hashColorGrid("rs-7"), productName: "Beach Towel", aspectRatio: "16:9", createdAt: "2026-02-14T11:00:00Z" },
    { id: "rs-8", colorGrid: hashColorGrid("rs-8"), productName: "Rashguard", aspectRatio: "9:16", createdAt: "2026-02-13T09:00:00Z" },
  ],
  "3": [
    { id: "rs-9", colorGrid: hashColorGrid("rs-9"), productName: "Yoga Mat", aspectRatio: "1:1", createdAt: "2026-02-16T08:00:00Z" },
    { id: "rs-10", colorGrid: hashColorGrid("rs-10"), productName: "Retreat Pass", aspectRatio: "3:4", createdAt: "2026-02-15T15:00:00Z" },
    { id: "rs-11", colorGrid: hashColorGrid("rs-11"), productName: "Block Set", aspectRatio: "16:9", createdAt: "2026-02-14T10:00:00Z" },
    { id: "rs-12", colorGrid: hashColorGrid("rs-12"), productName: "Meditation Cushion", aspectRatio: "1:1", createdAt: "2026-02-13T12:00:00Z" },
  ],
}
