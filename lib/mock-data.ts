...
export const MOCK_RECENT_STUDIO_IMAGES: Record<string, RecentStudioImage[]> = {
  "1": [
    ...
    { id: "rs-2", gradient: "linear-gradient(135deg, #3a2a1a 0%, #5a3a2a 50%, #4a2a1a 100%)", productName: "Espresso Blend", aspectRatio: "3:4", createdAt: "2026-02-15T11:00:00Z" },
  ...
  "2": [
    { id: "rs-5", gradient: "linear-gradient(135deg, #1a3a3a 0%, #2a5a5a 50%, #1a4a4a 100%)", productName: "Spring Wetsuit", aspectRatio: "3:4", createdAt: "2026-02-16T10:00:00Z" },
  ...
  "3": [
    ...
    { id: "rs-10", gradient: "linear-gradient(135deg, #1a3a2a 0%, #2a5a3a 50%, #1a4a2a 100%)", productName: "Retreat Pass", aspectRatio: "3:4", createdAt: "2026-02-15T15:00:00Z" },
